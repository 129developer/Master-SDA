 ...
 * @author bayasys
 */
public class ListenerDefinition extends javax.swing.JFrame {
    ...
    public ListenerDefinition(String jarPath) {
    ...
    private void initComponents() {
        ...
        def_txa = new javax.swing.JTextArea();
    ...
    private void save_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_btnActionPerformed
        if (fname_txt.getText().length() == 0) {
            dbUtils.showAlert("Please Enter a listener name.");
        }
        if (def_txa.getText().length() == 0) {
            dbUtils.showAlert("Please define the listener.");
        }
        JSONArray ary = new JSONArray();
        if (fileUtils.checkFileExist(jarPath + "data/Listeners.data")) {
            String dat = fileUtils.ReadFromFile(jarPath, "data/Listeners.data");
        ...
        fileUtils.WriteToFile(jarPath, "data/Listeners.data", ary.toString());
        dbUtils.showAlert("Listener saved successfully. on :" + jarPath + "data/Listeners.data");
    ...
    public static void main(String args[]) {
        ...
        ListenerDefinition ex = new ListenerDefinition(new File(ListenerDefinition.class.getProtectionDomain().getCodeSource().getLocation().toString()).getParentFile().getPath().replace("file:", "") + "/");
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ex.setTitle("Listener Definition");
    ...
    private javax.swing.JTextArea def_txa;
